...
void MainMenu::Render(SDL_Renderer* renderer)
{
    ...
    SDL_FRect title_rect = {
        static_cast<float>(window_width) / 2.0f - 100,
        100,
        200,
        60
    };
    ...
    {
        SDL_FRect option_rect = {
            static_cast<float>(window_width) / 2.0f - 80,
            option_y + static_cast<float>(i) * 60,
            160,
            40
        };
    ...
    SDL_FRect instruction_rect = {
        static_cast<float>(window_width) / 2.0f - 120,
        static_cast<float>(window_height) - 80,
        240,
        30
    };
